...
function Summary({ answers, dispatch }) {
  ...
  const submit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiBase}/api/eligibility`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ ...answers, ...contact }) });
